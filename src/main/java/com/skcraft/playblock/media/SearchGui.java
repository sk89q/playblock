...
public class SearchGui extends GuiScreen {
    ...
    public void initGui() {
        ...
        buttonList.add(searchButton = new GuiButton(0, left + 179, top + 14, 
                43, 20, LKey.SEARCH.toString()));

        queryField = new GuiTextField(fontRenderer, left + 38, top + 19, 150, fontRenderer.FONT_HEIGHT + 5);
    ...
    public void drawScreen(int mouseX, int mouseY, float par3) {
        ...
        mc.renderEngine.bindTexture("/playblock/gui/search_bg.png");
        int left = (width - xSize) / 2;
        int top = (height - ySize) / 2;
