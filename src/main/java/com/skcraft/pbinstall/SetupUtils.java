...
public final class SetupUtils {
    ...
    public static void openUrl(String url) {
        try {
            ...
            showMessageDialog(null, "Failed to open " + url, e, 
    ...
    public static void showMessageDialog(Component parentComponent,
            String message, String log, String title, int messageType) {
    ...
    public static void showMessageDialog(Component parentComponent,
            String message, Throwable t, String title, int messageType) {
        
        StringWriter writer = new StringWriter();
        writer.write("To report this error, please provide:\n\n");
        t.printStackTrace(new PrintWriter(writer));

        showMessageDialog(parentComponent, message, writer.toString(), title,
                messageType);
    }
